        ...
        while (isRunning)
        {
            ...
            switch (pilihan)
            {
                ...
                case "4":
                    ...
                    Console.WriteLine("SEMOGA HARI MU MENYENANGKAN.");
                    break;

                default:
                    Console.WriteLine("PILIHAN TIDAK ADA,PILIHAN NYA HANYA 1-4 :V");
                    break;
            }
            ...
            if (isRunning)
            {
                ...
                Console.WriteLine("TEKAN TOMBOL 4 UNTUK EXIT ATAU LAINNYA SESUAI KEBUTUHAN");
                Console.ReadKey();
            }
        }
    }
